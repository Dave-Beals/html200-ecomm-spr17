...
## Testing
  ...
  I tested the site through a variety of methods to check different aspects of its functionality. Throughout development, I tested it thoroughly on a Macbook laptop with Chrome and Safari browsers, as well as on an LG smartphone (Android). I also ran it through the following tests to verify it performs correctly:

  -Validated HTML an CSS in W3C validator
  -Checked responsivity on responsivedesignchecker.com
  -Webpage performance on webpagetest.org
  -Used Chrome Developer tools "Performance" feature to analyze page load
